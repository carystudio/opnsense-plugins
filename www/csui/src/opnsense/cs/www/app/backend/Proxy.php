...
//        $cicapStatus = self::cicapStatus();
        if(!is_dir("/usr/local/opnsense/cs/tmp/watch_tmp")){
        ...
        // (res)start daemon
        if ((string)$config['OPNsense']['clamav']['general']['enabled'] == 1) {
            if(!file_exists("/usr/local/opnsense/cs/tmp/watch_tmp/runicapcmd.txt")){
                file_put_contents("/usr/local/opnsense/cs/tmp/watch_tmp/runicapcmd.txt",'/bin/sh /usr/local/opnsense/cs/script/seticap.sh start');
            }
        ...
        try{
            ...
            if('0'==$data['general']['enabled']){
                ...
                if(!isset($data['general']['logging']['enable']['accessLog']) ||
                    ...
                    throw new AppException('enabled_access_log_error');
                }
                ...
                if(!isset($data['general']['logging']['enable']['storeLog']) ||
                    ...
                    throw new AppException('enabled_storage_error');
                }
                ...
                if(!isset($data['general']['dnsV4First']) ||
                    ...
                    throw new AppException('enabled_dnsv4_error');
                }
                ...
                if(!isset($data['general']['forwardedForHandling']) ||
                    ...
                    throw new AppException('xff_header_error');
                }
                ...
                if(!isset($data['general']['uriWhitespaceHandling']) ||
                    ...
                    throw new AppException('url_empty_error');
                }
                ...
                if(!isset($data['general']['suppressVersion']) ||
                    ...
                    throw new AppException('inhibite_version_error');
                }
                ...
                if(isset($data['general']['VisibleEmail']) && false === filter_var($data['general']['VisibleEmail'], FILTER_VALIDATE_EMAIL)){
                    throw new AppException('admin_email_error');
                }
                ...
                if(!isset($data['general']['cache']['local']['cache_mem']) ||
                    ...
                    throw new AppException('memory_cache_range_128_2048');
                }
                ...
                if(!isset($data['general']['cache']['local']['cache_linux_packages']) ||
                    ...
                    throw new AppException('enabled_linux_pack_error');
                }
                ...
                if(!isset($data['general']['cache']['local']['cache_windows_updates']) ||
                    ...
                    throw new AppException('enabled_win_pack_error');
                }
                ...
                if(!isset($data['general']['traffic']['enabled']) ||
                    ...
                    throw new AppException('enabled_traffic_error');
                }
                ...
                if('0' != $data['general']['traffic']['enabled']){
                    if(!isset($data['general']['traffic']['maxDownloadSize']) ||
                        ...
                        throw new AppException('max_down_size_error');
                    }
                    ...
                    if(!isset($data['general']['traffic']['maxUploadSize']) ||
                        ...
                        throw new AppException('max_upload_size_error');
                    }
                    ...
                    if(!isset($data['general']['traffic']['OverallBandwidthTrotteling']) ||
                        ...
                        throw new AppException('total_bw_limit_error');
                    }
                    ...
                    if(!isset($data['general']['traffic']['perHostTrotteling']) ||
                        ...
                        throw new AppException('host_adjust_param_error');
                    }
                    ...
                    if(empty($data['general']['traffic']['OverallBandwidthTrotteling']) &&
                        ...
                        throw new AppException('host_adjust_descr');
                    }
                    $conf_data['general']['traffic']['OverallBandwidthTrotteling'] = $data['general']['traffic']['OverallBandwidthTrotteling'];
                ...
                if(!isset($data['forward']['port']) ||
                    ...
                    throw new AppException('proxy_port_ssl_range_1_65535');
                }
                ...
                if(!isset($data['forward']['sslbump']) ||
                    ...
                    throw new AppException('enabled_ssl_error');
                }
                ...
                if(!isset($data['forward']['sslurlonly']) ||
                    ...
                    throw new AppException('sni_record_error');
                }
                ...
                if(!isset($data['forward']['ssl_crtd_storage_max_size']) ||
                    ...
                    throw new AppException('sslcache_sslca_error');
                }
                ...
                if(!isset($data['forward']['addACLforInterfaceSubnets']) ||
                    ...
                    throw new AppException('allow_interface_error');
                }
                ...
                if(!isset($data['forward']['transparentMode']) ||
                    ...
                    throw new AppException('enabled_transpare_http_proxy_error');
                }
                ...
                if(isset($data['ICAP'])){
                    if(!isset($data['ICAP']['enabled']) || !Util::check0and1($data['ICAP']['enabled'])){
                        throw new AppException('icap_enabled_error');    //ICAP开启参数错误
                    }
                ...
                if(!isset($data['forward']['acl']['safePorts'])){
                    throw new AppException('allow_dest_tcp_port_error');
                }
                ...
                if(!isset($data['forward']['acl']['sslPorts'])){
                    throw new AppException('allow_ssl_port_error');
                }
                ...
                if(isset($data['general']['enabled']) && '1' == $data['general']['enabled']){
                    $memory = get_memory();
                    if($memory[0] < 1800){
                        throw new AppException('memory_short_note');     //内存不足，无法开启病毒检测功能
                    }
                    if(!isset($data['ICAP']['enabled']) || !Util::check0and1($data['ICAP']['enabled'])){
                        throw new AppException('icap_enabled_error');     //ICAP开启参数错误
                    }
                    ...
                    if(!isset($data['ICAP']['enable_accesslog']) || !Util::check0and1($data['ICAP']['enable_accesslog'])){
                        throw new AppException('icap_access_log_error');     //ICAP访问日志开启参数错误
                    }
                    if(!isset($data['CLAMAV']['disablecache']) || !Util::check0and1($data['CLAMAV']['disablecache'])){
                        throw new AppException('icap_cache_error');     //ICAP缓存参数不正确
                    }
                    if(!isset($data['CLAMAV']['maxfilesize']) || !is_numeric($data['CLAMAV']['maxfilesize'])){
                        throw new AppException('max_file_size_error');     //病毒检测最大扫描文件参数不正确
                    }
